    ...
    return (
        <div className="space-y-8 pb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-gray-900 p-6 rounded-xl border border-gray-800 flex flex-col gap-6">
                    ...
                    <div className="bg-gray-950/50 p-4 rounded-lg flex-1 flex flex-col justify-center items-center">
                        ...
                        <span className={`text-2xl sm:text-4xl font-bold ${totalProfit >= 0 ? 'text-green-400' : 'text-red-400'}`}>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden">
                ...
                <div className="p-4 grid grid-cols-2 gap-3 bg-gray-950/30 border-b border-gray-800">
                    ...
                    <button
                        ...
                        disabled={processing}
                        className="col-span-2 bg-cyan-600 hover:bg-cyan-500 text-white rounded-lg flex items-center justify-center gap-2 font-medium disabled:opacity-50 disabled:cursor-not-allowed py-2"
                    >
