    ...
    return (
        <div className="space-y-6 pb-20">
            ...
            <div className="bg-gray-900 border border-gray-800 p-3 sm:p-4 rounded-2xl flex flex-wrap gap-3 sm:gap-4 items-end shadow-lg">
                ...
                <button onClick={handleExportForAI} className="bg-gray-800 hover:bg-gray-700 text-gray-300 border border-gray-700 p-2 rounded-lg transition-all shadow-lg active:scale-95 flex items-center gap-2 text-sm font-medium px-3 sm:px-4 h-[38px] sm:ml-auto justify-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="bg-gray-900 border border-gray-800 p-6 rounded-2xl shadow-lg relative overflow-hidden group">
                    ...
                    <p className="text-2xl sm:text-3xl font-bold text-gray-100 mt-2">
                ...
                <div className="bg-gray-900 border border-gray-800 p-6 rounded-2xl shadow-lg relative overflow-hidden group">
                    ...
                    <p className="text-2xl sm:text-3xl font-bold text-gray-100 mt-2 text-green-400">
